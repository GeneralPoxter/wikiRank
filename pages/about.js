    ...
    return (
        <div className='bg-[#1e1e2e]'>
            ...
            <div className='p-[3em] mx-[5%] text-[#cdd6f4] bg-[#181825] rounded-xl'>
                ...
                <blockquote className={blockStyle + " italic"}>
                    <p className={blockTextStyle}>In a document retrieval, or other pattern matching environment where stored entities (documents) are compared with each other or with incoming patterns (search requests), it appears that the best indexing (property) space is one where each entity lies as far away from the others as possible; in these circumstances the value of an indexing system may be expressible as a function of the density of the object space; in particular, retrieval performance may correlate inversely with space density. An approach based on space density computations is used to choose an optimum indexing vocabulary for a collection of documents. Typical evaluation results are shown, demonstating the usefulness of the model.</p>
                    <br></br>
                    <p className={blockTextStyle}>&#8212; "A vector space model for automatic indexing" (Salton, Wong, & Yang 1975)</p>
                </blockquote>
